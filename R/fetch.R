...
#'
#' @param waves wave number, multiple waves can be put into a vector
#' @param vars a vector containing all desired variable names to be loaded.
#' vars can be set to "all" to fetch all columns. This may take a long time to load
#'
